...
export class createTfasdgg1657121151267 implements MigrationInterface {
    name = 'createTfasdgg1657121151267'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`area\` ADD \`aaaa\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`comment\` DROP COLUMN \`parkId\``);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD \`parkId\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`area\` DROP COLUMN \`aaaa\``);
