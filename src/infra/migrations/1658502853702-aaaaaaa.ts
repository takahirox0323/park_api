...
export class aaaaaaa1658502853702 implements MigrationInterface {
  name = "aaaaaaa1658502853702";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TABLE `park` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `address` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `prefectureId` varchar(255) NOT NULL, `areaId` varchar(255) NOT NULL, `countryId` varchar(255) NOT NULL, `parkTypeId` int NOT NULL, `parkUrl` varchar(255) NOT NULL, `openingTime` varchar(255) NOT NULL, `price` varchar(255) NOT NULL, `createdUserId` varchar(255) NOT NULL, `parkStatusId` varchar(255) NOT NULL, `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `tagId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB"
    );
    await queryRunner.query(
      "CREATE TABLE `photo` (`id` int NOT NULL AUTO_INCREMENT, `key` varchar(255) NOT NULL, `parkId` varchar(255) NOT NULL, `createdUserId` varchar(255) NOT NULL, `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB"
    );
    await queryRunner.query(
